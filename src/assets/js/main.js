(function($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({ siteLogo: "<a href='http://sjcknl.edu.in/Default.aspx' class='logo-mobile-menu'><img src='assets/img/mobile-logo.png' /></a>" });
    ...
    /*-------------------------------------
     ...
     -------------------------------------*/
    $('#countdown').countdown('2020/02/09', function(e) {
